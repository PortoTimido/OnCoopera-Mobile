...
type DiarioTopBarProps = {
  dateTimeLabel: string;
  initials: string;
};

export function DiarioTopBar({ dateTimeLabel, initials }: DiarioTopBarProps) {
  return (
    <View className="h-[66px] flex-row items-center justify-between border-b border-home-border bg-home-surface px-4">
      ...
      <Link asChild href="/configuracoes">
        <Pressable accessibilityLabel="Configurações" accessibilityRole="button" className="size-8 items-center justify-center rounded-pill" hitSlop={8}>
